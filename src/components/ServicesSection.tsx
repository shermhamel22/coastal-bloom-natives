        ...
        {services.map((s) => (
          ...
          >
            ...
            <div className="absolute bottom-4 left-4">
              <span className="inline-flex items-center gap-2 bg-foreground/90 text-primary-foreground text-xs font-extrabold uppercase tracking-wider px-4 py-2 rounded-sm">
